 ...
 * it creates a ScriptEngineManager, then merges them. @link ScriptEngineFactory
 ...
 * ContextClassloader for finding resources need to use this wrapper and the @link
 ...
 * <ul>
 * <li>
 * All factories are wrapped with an {@link OSGiScriptEngineFactory}. As Engines
...
// modified version of http://svn.apache.org/repos/asf/felix/trunk/mishell/src/main/java/org/apache/felix/mishell/OSGiScriptEngineManager.java
public class OSGiScriptEngineManager extends ScriptEngineManager {
   private static final Logger LOGGER = LoggerFactory.getLogger(OSGiScriptEngineManager.class);
    ...
    * weren't available before, but keeping the globalScope bindings set. If you
   ...
   private static ScriptEngineManager tryCreateScriptEngineManager(
      ...
      try {
         ...
         LOGGER.error("Found ScriptEngineFactory candidate {} but failed to create a factory due to: {}",
